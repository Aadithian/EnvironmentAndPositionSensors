...
public class GameRotationDataActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sensor == null) {
            textViewXAxis.setText("Game Rotation Vector sensor not available on this device");
        }
    }
